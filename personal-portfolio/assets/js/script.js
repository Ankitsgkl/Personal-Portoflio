...
var typed = new Typed(".typing-text", {
    strings: ["Frontend development", "Backend development", "Web development", "Full Stack Web Development"],
    loop: true,
    typeSpeed: 60,
    backSpeed: 30,
    backDelay: 500,
...
srtop.reveal('.home .image', { delay: 350 });
srtop.reveal('.home .linkedin', { interval: 550 });
srtop.reveal('.home .github', { interval: 750 });
srtop.reveal('.home .twitter', { interval: 950 });
srtop.reveal('.home .telegram', { interval: 550 });
srtop.reveal('.home .instagram', { interval: 550 });
srtop.reveal('.home .dev', { interval: 550 });
...
/* SCROLL CONTACT */
srtop.reveal('.contact .container', { delay: 350 });
